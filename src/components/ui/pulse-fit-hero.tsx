  ...
  return (
    ...
    >
      ...
      {children ? (
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4" style={{ paddingTop: '100px' }}>
          <motion.div
              ...
              >
                {primaryAction && (
                  ...
                  >
                    ...
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" style={{ marginLeft: '4px' }}>
                      <path
