  ...
  ({ title, subtitle, images, appStoreLink, googlePlayLink, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative w-full min-h-[70vh] flex flex-col items-center justify-center overflow-x-hidden bg-background text-foreground p-4',
          className
        )}
        {...props}
      >
        ...
        <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter max-w-4xl" style={{ fontFamily: 'var(--font-display)' }}>
              {title}
            </h1>
            <p className="max-w-2xl mx-auto text-muted-foreground md:text-xl" style={{ fontFamily: 'var(--font-body)', color: 'var(--text-secondary)' }}>
              {subtitle}
            </p>
          </div>
          ...
          <div className="relative w-full h-[350px] md:h-[450px] flex items-center justify-center">
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-2 sm:left-8 top-1/2 -translate-y-1/2 rounded-full h-10 w-10 z-20 bg-background/50 backdrop-blur-sm text-black border-black/20"
              onClick={handlePrev}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-2 sm:right-8 top-1/2 -translate-y-1/2 rounded-full h-10 w-10 z-20 bg-background/50 backdrop-blur-sm text-black border-black/20"
              onClick={handleNext}
            >
